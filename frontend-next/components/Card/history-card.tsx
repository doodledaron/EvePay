...
const HistoryCard = () => {
  ...
  useEffect(() => {
    const fetchTransactions = fetch("http://127.0.0.1:8000/maschain_token/api_get_all_transaction/0x5b3a8eCB9677F56e46d67B7e69900cE322c030d1")
      .then((response) => {
        if (!response.ok) {
    ...
    const fetchBalance = fetch("http://127.0.0.1:8000/maschain_token/api_check_balance", {
      method: "POST",
      headers: {
